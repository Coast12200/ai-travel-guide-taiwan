...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const i18nMappings = [
        ...
        // AI 行程規劃師
        { selector: '#itineraryPrefs', attr: 'ai_input_placeholder', type: 'placeholder' },
        { selector: '#openDownloadSheet', attr: 'btn_download_itinerary' },
        { selector: '#transportBtn', attr: 'btn_transport_plan' },
        { selector: '#downloadTransportPdfBtn', attr: 'btn_download_transport_pdf' },
