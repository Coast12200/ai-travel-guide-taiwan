...
export const translations = {
    ...
    // Time Formats
    time_just_now: { zh: '剛剛', en: 'Just now' },
    time_mins_ago: { zh: '分鐘前', en: 'mins ago' },
    time_hours_ago: { zh: '小時前', en: 'hours ago' },
    time_days_ago: { zh: '天前', en: 'days ago' },
    ...
    ai_input_placeholder: { zh: '您想要什麼樣的旅程？(例如: 親子友善、美食探索、文青慢活...)', en: 'What kind of trip do you want? (e.g., Family-friendly, Foodie, Relaxed...)' },
    btn_download_itinerary: { zh: '下載行程', en: 'Download' },
    btn_transport_plan: { zh: '🚗 交通規劃', en: '🚗 Transport' },
    btn_download_transport_pdf: { zh: '📄 下載交通 PDF', en: '📄 Download Transport PDF' },
    ...
    style_cultural: { zh: '文化探索', en: 'Cultural Exploration' },
    style_adventure: { zh: '冒險刺激', en: 'Adventure' },
